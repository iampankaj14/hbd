...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Dec 06, 2025 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["👑💖 Happy Birthday To My Queen, Ranya! 💖👑", 
    "My Dearest Ranya, My One and Only Famous Bubu Don! 🥰", " ",
    "Aaj ka din kitna special hai! It's my Darling's Birthday! 🎂 Wishing you the most spectacular and happiest birthday ever! 🥳🎈",
    " ", 
    "May God bless you always and fill your life with infinite happiness, love, and success. ✨"],
  startDelay: 2000,
  speed: 95,
...
new TypeIt("#teks2", {
  strings: ["Dekho Dekho kitna blush krri ho 🌝, First birthday celebrate krre h sath me. Yayyyyyy.", " ",
    "Meri bus yahi dua hai ki aap life mein itne zyada successful bano ki duniya dekhti reh jaye! Aur haan... uss success se... aap mujhe world ki best chizein kharid kar de sako! 😉 Hehehe! (I deserve it, right?) 😉💰", "Lobe u bubu soo much!!!!, ", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
...
new TypeIt("#trims", {
  strings: ["I love you soo much my FWB🌝."],
  startDelay: 2000,
  speed: 70,
  loop: false,
  waitUntilVisible: true,
